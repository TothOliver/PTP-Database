...
query_button2.grid(row=0, column=0, padx=150, pady=5, ipadx=0, ipady=0, sticky='w')

query_button3 = tk.Button(window, text="Show enemy types", command=lambda: run_query_wrapper(3))
query_button3.grid(row=0, column=0, padx=280, pady=5, ipadx=0, ipady=0, sticky='w')
...
player1_id_entry.grid(row=2, column=0, padx=200)
...
card_name_entry.grid(row=4, column=0, padx=0)
...
name_entry.grid(row=8, column=0, padx=200)
...
avg_round_entry.grid(row=9, column=0, padx=200)
...
highscore_entry.grid(row=10, column=0, padx=200)
...
playtime_entry.grid(row=11, column=0, padx=200)
...
player_id_entry.grid(row=13, column=0, padx=200)
...
card_id_entry.grid(row=14, column=0, padx=200)
...
pick_rate_entry.grid(row=15, column=0, padx=200)
...
upgrade_rate_entry.grid(row=16, column=0, padx=200)
